...
def register(user_id, password):
        ...
        while True:
            ...
            library.add_new_user(user_id_str)  #new user has been added to movie rating
...
def menu(user_id):
    if user_id in movie_ratings and len(movie_ratings[user_id]) > 0:
        while True:
            ...
            if cmd == 'update':
                ...
                while True:
                    ...
                    if movie_to_update == 'back':
                        ...
                        print("Updated list of rated movies.")
                        library.print_ratings(user_id)
            elif cmd == 'display':
                ...
                while True:
                    ...
                    if (movie_to_delete == 'back'or movie_to_delete not in movie_ratings[user_id]):
                        #print("You have not rated this movie or you choose break.")
                        break
                    else:
                        library.delete_rating(user_id, movie_to_delete)
                        print("Updated list movies of rated movies.")
                        library.print_ratings(user_id)
            elif cmd == 'recommend':
